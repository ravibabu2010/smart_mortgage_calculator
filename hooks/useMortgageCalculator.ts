...
export const useMortgageCalculator = (inputs: CalculatorInput | null) => {
  return useMemo(() => {
    ...
    while (remainingBalance > 0) {
      ...
      schedule.push({
        period,
        // FIX: Replaced incorrect toLocaleDateTimeString with toISOString and slicing to get a consistent YYYY-MM-DD format.
        date: paymentDate.toISOString().split('T')[0], // Use a consistent format
    ...
    // FIX: Added timeZone option to prevent date shifts when converting to a string.
